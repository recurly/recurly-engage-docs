...
* **Create a pop-up**: Design, schedule, and deploy browser-based prompts—pop-ups, interstitials, notifications, or video prompts—to engage users. <a href="https://docs.recurly.com/recurly-engage/docs/create-a-pop-up-recurly-engage#/" target="_blank" rel="noopener">Learn more</a>
* **Activate prompts**: Move prompts through review (Test Users) to full deployment, choose placement methods, and control their lifecycle. <a href="https://docs.recurly.com/recurly-engage/docs/activate-prompts#/" target="_blank" rel="noopener">Learn more</a>
* **Create an experiment**: A/B test prompt variations against custom goals or controls to identify the highest-performing experience. <a href="https://docs.recurly.com/recurly-engage/docs/create-an-experiment#/" target="_blank" rel="noopener">Learn more</a>
