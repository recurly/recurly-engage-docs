...
Recurly Engage supports a variety of proven engagement patterns to drive conversions, increase retention, and maximize customer value across the entire subscriber lifecycle. Including:&#x20;

- Acquisition
- Upsell
- Retention
- Winback
- General engagement (system notifications or user engagement campaigns)
...
| Acquisition                                                                                                           | Engagement                                                                                                              | Upsell                                                                                                               | Retention                                                                                      |
| --------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
...
| _—_                                                                                                                   | **Improve Error Experience**<br />Prompt users experiencing errors with acknowledgement or offer                        | _—_                                                                                                                  | **Win Back Guide**<br />Guide save-offer or dunning users back to engagement                   |
